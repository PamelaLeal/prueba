...
<div>
    ...
    <div id="wrapper">
        ...
        <form  method="GET" id="res" name="res" enctype="multipart/form-data" action="resultadosELE.php" >
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div>
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                    ...
                                    id="menu-toggle" href="#menu-toggle" style="color: #282550;"><i
                                        class="fa fa-bars"></i></a><a class="fa fa-language">&nbsp;&nbsp;Escuela de Lenguas</a></h1>
                                        <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="item-1-1-tab"
                                                data-toggle="tab" role="tab" aria-controls="item-1-1"
                                                aria-selected="true" href="#item-1-1">Licenciatura en Docencia de Lengua Inglesa</a></li>
                                    </ul>
                                </div>
                    <?php   
                 ...
                 $acentos = $db->query("SET NAMES 'utf8'");
                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion
                            from student where faculty='ELe'") or die ("Sin establecer conexion!!");
			...
			<tr>
			   ...
			   <?php 
                ...
                ?>
        			...
        			<td>
                    <a href="eliminarELe.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
        			</td>
        			</tr>
        		<?php
        		}
