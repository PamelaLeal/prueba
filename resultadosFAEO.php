...
<div>
    ...
    <div id="wrapper">
        <div class="text-nowrap" id="sidebar-wrapper" style="color: #46a1fc;background-color: rgb(37,40,80);">
         ...
         <form  method="GET" enctype="multipart/form-data" action="resultadosFAEO.php" >
                        ...
                        <div>
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                    ...
                                    id="menu-toggle" href="#menu-toggle" style="color: #282550;"><i
                                        class="fa fa-bars"></i></a><a class="fa fa-medkit">&nbsp;&nbsp;Facultad de Enfermería y Obstetricia</a></h1>
                                        <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="item-1-1-tab"
                                                data-toggle="tab" role="tab" aria-controls="item-1-1"
                                                aria-selected="true" href="#item-1-1">Licenciatura en Enfermería</a></li>
                                 ...
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FAEO' && career like '%s'") or die ("Sin establecer conexion!!");
                            ...
                            <tr>
                               ...
                               <?php 
                                ...
                                ?>
                                    ...
                                    <td>
                                    <a href="eliminarFAEO.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
                                    </td>
                                    </tr>
                                <?php
                                }
                             ...
                             ?>
                                 ...
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FAEO' && career like '%o'") or die ("Sin establecer conexion!!");
