...
<div>
    ...
    <div id="wrapper">
        <div class="text-nowrap" id="sidebar-wrapper" style="color: #46a1fc;background-color: rgb(37,40,80);">
         ...
         <form  method="GET" enctype="multipart/form-data" action="resultadosFCQ.php" >
                    ...
                    <div class="col-md-12">
                        <div>
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                ...
                                <div class="card-header">
                                 ...
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FCQ' && career like 'I%'") or die ("Sin establecer conexion!!");
                            ...
                            <tr>
                               ...
                               <?php 
                                ...
                                ?>
                                    ...
                                    <td>
                                    <a href="eliminarFCQ.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
                                    </td>
                                    </tr>
                                <?php
                                }
                             ...
                             ?>
                                 ...
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FCQ' && career like '%Biotecnólogo'") or die ("Sin establecer conexion!!");
                            ...
                            <div id="item-1-3" class="tab-pane fade" role="tabpanel"
                                 ...
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FCQ' && career like '%Biólogo'") or die ("Sin establecer conexion!!");
