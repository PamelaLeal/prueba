...
<div>
    ...
    <div id="wrapper">
        ...
        <form  method="GET" enctype="multipart/form-data" action="resultadosFADERyCIPOL.php" >
                            ...
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                ...
                                <div class="card-header">
                                 ...
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FADERYCIPOL' && career like '%s'") or die ("Sin establecer conexion!!");
                            ...
                            <tr>
                               ...
                               <?php 
                                ...
                                ?>
                                    ...
                                    <td>
                                    <a href="eliminarFADERyCIPOL.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
                                    </td>
                                    </tr>
                                <?php
                                }
                             ...
                             ?>
                                 ...
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FADERYCIPOL' && career like '%o'") or die ("Sin establecer conexion!!");
