...
<div>
    ...
    <div id="wrapper">
        ...
        <form  method="GET" enctype="multipart/form-data" action="resultadosEPEA.php" >
                        ...
                        <div>
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                    ...
                                    id="menu-toggle" href="#menu-toggle" style="color: #282550;"><i
                                        class="fa fa-bars"></i></a><a class="fa fa-paint-brush">&nbsp;&nbsp;Escuela de Pintura, Escultura y Artesanías</a></h1>
                                        <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="item-1-1-tab"
                                                data-toggle="tab" role="tab" aria-controls="item-1-1"
                                                aria-selected="true" href="#item-1-1">
Técnico Superior Universitario en Diseño y Producción Artesanal</a></li>
                                                <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab"
                                                role="tab" aria-controls="item-1-2" aria-selected="false"
                                                href="#item-1-2">Licenciado en Artes Visuales y Plásticas</a></li>
                                    </ul>
                                </div>
                            <?php   
                                 ...
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='EPEA' && career like 'T%'") or die ("Sin establecer conexion!!");
                            ...
                            <tr>
                               ...
                               <?php 
                                ...
                                ?>
                                    ...
                                    <td>
                                    <a href="eliminarEPEA.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
                                    </td>
                                    </tr>
                                <?php
                                }
                             ...
                             ?>
                                ...
                                <?php   
                                 ...
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='EPEA' && career like 'L%'") or die ("Sin establecer conexion!!");
