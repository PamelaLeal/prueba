...
<div>
    ...
    <div id="wrapper">
        <div class="text-nowrap" id="sidebar-wrapper" style="color: #46a1fc;background-color: rgb(37,40,80);">
         ...
         <form  method="GET" enctype="multipart/form-data" action="resultadosFECA.php" >
                        ...
                        <div>
                            <h1 style="font-size: 35px;font-weight: bold;color: #282550;"><a 
                                    ...
                                    id="menu-toggle" href="#menu-toggle" style="color: #282550;"><i
                                        class="fa fa-bars"></i></a><a class="fa fa-bar-chart">&nbsp;&nbsp;Facultad de Economía, Contaduría y Administración</a></h1>
                                        <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="item-1-1-tab"
                                                data-toggle="tab" role="tab" aria-controls="item-1-1"
                                                aria-selected="true" href="#item-1-1">Contador Público</a></li>
                                                <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab"
                                                role="tab" aria-controls="item-1-2" aria-selected="false"
                                                href="#item-1-2">Licenciado en Administración</a></li>
                                                <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab"
                                                role="tab" aria-controls="item-1-3" aria-selected="false"
                                                href="#item-1-3">Licenciado en Economía y Negocios Internacionales</a></li>
                                    </ul>
                                </div>
                                 <?php   
                                 ...
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FECA' && career like 'C%'") or die ("Sin establecer conexion!!");
                            ...
                            <tr>
                               ...
                               <?php 
                                ...
                                ?>
                                    ...
                                    <td>
                                    <a href="eliminarFECA.php?id=<?php echo $ver['id']; ?>" class='btn-danger' onclick="return eliminarD()"><em class='fa fa-trash'></em> Eliminar</a>
                                    </td>
                                    </tr>
                                <?php
                                }
                             ...
                             ?>
                                    ...
                                    <div id="item-1-2" class="tab-pane fade" role="tabpanel"
                                                aria-labelledby="item-1-2-tab">
                                                 <?php   
                                   
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FECA' && career like '%n'") or die ("Sin establecer conexion!!");
                            ...
                            <div id="item-1-3" class="tab-pane fade" role="tabpanel"
                                                aria-labelledby="item-1-3-tab">
                                     <?php   
                                   
                                 include("conexion.php");
                                 $acentos = $db->query("SET NAMES 'utf8'");
                                    $sql=mysqli_query($db,"SELECT id,career,age,foraneo,civil,semester, religion from student where faculty='FECA' && career like '%s'") or die ("Sin establecer conexion!!");
